...
Runner_Oracle.prototype._stream = Promise.method(function (obj, stream, options) {
  ...
  return new Promise(function (resolver, rejecter) {
    ...
    var queryStream = new OracleQueryStream(self.isQuoting(), self.connection, obj.sql, obj.bindings, options);
...
Runner_Oracle.prototype.processResponse = function(obj) {
  ...
  var response = this.isQuoting() ? obj.response : utils.convertQueryResultCase(obj.response);
